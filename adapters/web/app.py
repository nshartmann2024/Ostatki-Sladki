...
SEO_INGREDIENTS = {
    ...
    "черствый-хлеб": (
        "черствого хлеба",
        "Не выбрасывайте черствый хлеб. Из него можно приготовить простые и вкусные блюда: гренки, запеканки, супы и десерты.\n\n"
        "Если хлеб зачерствел, это ещё не повод с ним прощаться. В домашней кухне такие остатки легко превращаются в сытный завтрак, быстрый ужин или что-нибудь сладкое к чаю.\n\n"
        "В австрийской кухне черствый хлеб используют постоянно — это практичный и вкусный подход, при котором хорошие продукты не пропадают.\n\n"
        "Выберите рецепт ниже и попробуйте приготовить что-то из того, что уже есть у вас на кухне.",
    ),
    "хлеб-яйцо": (
        "хлеба и яиц",
        "Простые рецепты из хлеба и яиц: гренки, запеканки и быстрые завтраки из доступных продуктов.\n\n"
        "Хлеб и яйца — одно из самых простых и удачных сочетаний на кухне. Даже из минимального набора продуктов можно приготовить сытное и вкусное блюдо.\n\n"
        "Из хлеба и яиц получаются классические гренки, запеканки и простые горячие завтраки. Такие рецепты особенно выручают, когда нужно приготовить быстро и из того, что уже есть дома.\n\n"
        "В домашней и венской кухне это базовое сочетание используют часто — просто, доступно и всегда работает.\n\n"
        "Выберите рецепт ниже и попробуйте приготовить что-нибудь вкусное уже сегодня.",
    ),
    "хлеб-сыр": (
        "хлеба и сыра",
        "Простые рецепты из хлеба и сыра: тосты, запеканки и быстрые блюда из доступных продуктов.\n\n"
        "Хлеб и сыр — одно из самых понятных и любимых сочетаний. Даже из самых простых продуктов можно приготовить горячие, сытные и очень вкусные блюда.\n\n"
        "Из хлеба и сыра получаются тосты, запеканки, закуски и быстрые ужины. Такие рецепты особенно удобны, когда нужно приготовить быстро и без лишних ингредиентов.\n\n"
        "В домашней кухне это сочетание используют постоянно — просто, доступно и всегда вкусно.\n\n"
        "Выберите рецепт ниже и попробуйте приготовить что-нибудь из того, что уже есть у вас дома.",
    ),
}

# Для SEO-ингредиентов, у которых поиск идёт по другому каноническому slug (например картофель-быстро → картофель)
SEO_INGREDIENT_TO_SEARCH_QUERY = {"картофель-быстро": "картофель", "черствый-хлеб": "хлеб", "хлеб-яйцо": "хлеб", "хлеб-сыр": "хлеб"}
